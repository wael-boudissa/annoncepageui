...
const House = ({ house }) => {
  ...
  return (
    <Link to ="/contactuser"><div className='bg-white shadow-1 p-5 rounded-lg w-full max-w-[352px] mx-auto cursor-pointer hover:shadow-2xl transition'>
    ...
    <div className='flex-left mb-4'> <FaHeart /> </div>
